...
Name "PasswordMaker Java Edition (64-bit)"
...
OutFile ..\dist\passwordmaker-je-win32-x64-${VERSION}-setup.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\pwmje-win32-win32_x86_64-${VERSION}.jar "" "$INSTDIR\pwmje.ico" 0
...
Function .onInit
    ...
    ReadRegStr $R0 HKLM \
    "SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\$(^Name)" \
    "UninstallString"
    StrCmp $R0 "" done
